...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # First block argument is the accumulator.  First run of the block defaults
    # To what is accumulated in the inject method.
    # At the end of the iteration, inject returns the accumulator. 
